        ...
        <div class="news-index-columns" v-show="activeTab === 'latest'">
          <ul class="news-index-list state col">
            <li v-for="item in latestLeft" :key="item.href">
              <a target="_self" class="news-tit" :title="item.title" :href="item.href">
                {{ item.title }}
              </a>
...
const latestList = ref([
  {
    title: '公 告',
    href: 'http://www.12306.cn/mormhweb/zxdt/202412/t20241211_43192.html',
    time: '2024-12-11'
  },
  {
    title: '关于铁路客运推广使用全面数字化的电子发票的公告',
    href: 'http://www.12306.cn/mormhweb/zxdt/202410/t20241023_43048.html',
    time: '2024-11-07'
  },
  {
    title: '关于优化铁路车票改签规则的公告',
    href: 'http://www.12306.cn/mormhweb/zxdt/202401/t20240111_40579.html',
    time: '2024-01-11'
  },
  {
    title: '外国护照身份核验使用说明',
    href: 'http://www.12306.cn/mormhweb/zxdt/202311/t20231127_40375.html',
    time: '2023-12-13'
  },
  {
    title: '铁路旅客禁止、限制携带和托运物品目录',
    href: 'http://www.12306.cn/mormhweb/zxdt/202206/t20220617_37625.html',
    time: '2023-11-30'
  },
  {
    title: '候补购票操作说明',
    href: 'http://www.12306.cn/mormhweb/zxdt/201905/t20190521_22980.html',
    time: '2024-04-19'
  },
  {
    title: '公 告',
    href: 'http://www.12306.cn/mormhweb/zxdt/201512/t20151201_3949.html',
    time: '2022-12-22'
  },
  {
    title: '关于铁路车站起售时间的公告',
    href: 'http://www.12306.cn/mormhweb/zxdt/201411/t20141126_2316.html',
    time: '2025-11-14'
  },
  {
    title: '中国铁路成都局集团有限公司关于2025年11月15日至26日加开部分列车的公告',
    href: 'http://www.12306.cn/mormhweb/zxdt_news/202511/t20251114_45061.html',
    time: '2025-11-14'
  },
  {
    title: '中国铁路成都局集团有限公司关于2025年11月14日至26日加开部分列车的公告',
    href: 'http://www.12306.cn/mormhweb/zxdt_news/202511/t20251113_45058.html',
    time: '2025-11-13'
  }
])
...
.news-index-list.state .news-tit {
  grid-column: 2;
}
.news-index-list.state .news-time {
  grid-column: 3;
}
...
.discredit-list dt .icon-wrap {
  display: inline-flex;
  align-items: center;
  justify-content: center;
}
.discredit-list dt .icon-svg {
  width: 18px;
  height: 18px;
  fill: #2e64fe;
